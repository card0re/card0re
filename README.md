...
|---|---|
| [trading-bot](https://github.com/card0re/trading-bot) | Binance USDT-M futures bot with walk-forward backtesting, order-flow filters and a paper-trading rotation strategy |
| [fiber-wallet-ledger](https://github.com/card0re/fiber-wallet-ledger) | Multi-currency wallet ledger API with atomic DB transactions (Fiber + GORM) |
| [crypto-rate-calculator](https://github.com/card0re/crypto-rate-calculator) | Cross-rate calculator on live Binance prices, decimal math, fee margin, admin overrides |
| [tg-otp-auth](https://github.com/card0re/tg-otp-auth) | Passwordless phone verification via Telegram bot instead of SMS (PostgreSQL) |
| [tg-alert-dispatcher](https://github.com/card0re/tg-alert-dispatcher) | Stdlib-only HTTP → Telegram alert broadcaster for microservices |
